...
#endif
/* Stub implementations for enum ordering compatibility */
BPF_PROG_TYPE(BPF_PROG_TYPE_CGROUP_DEVICE, cg_dev_prog_ops)
BPF_PROG_TYPE(BPF_PROG_TYPE_SK_MSG, sk_msg_prog_ops)
BPF_PROG_TYPE(BPF_PROG_TYPE_RAW_TRACEPOINT, raw_tp_prog_ops)
...
BPF_PROG_TYPE(BPF_PROG_TYPE_LIRC_MODE2, lirc_mode2_prog_ops)
BPF_PROG_TYPE(BPF_PROG_TYPE_SK_REUSEPORT, sk_reuseport_prog_ops)
BPF_PROG_TYPE(BPF_PROG_TYPE_FLOW_DISSECTOR, flow_dissector_prog_ops)
BPF_PROG_TYPE(BPF_PROG_TYPE_CGROUP_SYSCTL, cg_sysctl_prog_ops)
BPF_PROG_TYPE(BPF_PROG_TYPE_RAW_TRACEPOINT_WRITABLE, raw_tp_writable_prog_ops)
...
#endif
/* Unsupported Maps in 3.10 - cpumap requires per-cpu redirect infra */
/* BPF_MAP_TYPE(BPF_MAP_TYPE_CPUMAP, cpu_map_ops) */
BPF_MAP_TYPE(BPF_MAP_TYPE_DEVMAP_HASH, dev_map_ops)
