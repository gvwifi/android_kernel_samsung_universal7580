...
#define cmpxchg_relaxed(ptr, old, new) cmpxchg(ptr, old, new)
#endif
...
#ifndef USB_DT_USB_SSP_CAP_SIZE
...
#define USB_EP_MAXP_MULT(p)	(1 + (((p) & 0x1800) >> 11))
#endif
...
static inline int usb_endpoint_maxp_mult(const struct usb_endpoint_descriptor *epd)
{
	...
	return USB_EP_MAXP_MULT(maxp);
}

#ifndef OTG_STS_SELECTOR
...
#define dev_consume_skb_any(skb) consume_skb(skb)
#endif

#ifndef netif_trans_update
#define netif_trans_update(dev) ((dev)->trans_start = jiffies)
#endif

#ifndef tty_throttled
#define tty_throttled(tty) test_bit(TTY_THROTTLED, &(tty)->flags)
#endif
...
#ifndef stream_open
#define stream_open(inode, file) 0
#endif
...
/* USB Speed Super Plus compatibility for 3.10 */
#ifndef USB_SPEED_SUPER_PLUS
#define USB_SPEED_SUPER_PLUS 7
#endif

#ifndef USB_MAX_STRING_LEN
