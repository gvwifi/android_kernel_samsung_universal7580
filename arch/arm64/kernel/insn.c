...
#include <asm/insn.h>
/* kprobes not supported in kernel 3.10, comment out */
/* #include <asm/kprobes.h> */

/* Compatibility defines for kernel 3.10 */
#ifndef __pa_symbol
...
/* Add FIX_TEXT_POKE0 if not defined */
#ifndef FIX_TEXT_POKE0
/* Use an unused fixmap slot or define a new one */
#define FIX_TEXT_POKE0 (FIX_EARLYCON_MEM_BASE + 1)
#endif

/* stop_machine_cpuslocked not available in 3.10, use regular stop_machine */
