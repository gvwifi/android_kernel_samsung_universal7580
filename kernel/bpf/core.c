				  ...
				  gfp_t gfp_extra_flags)
{
	...
	if (WARN_ONCE(!fp_old, "bpf_prog_realloc: fp_old is NULL"))
		return NULL;
				       ...
				       const struct bpf_insn *patch, u32 len)
{
	 ...
	 */
	if (WARN_ONCE(bpf_adj_branches(prog_adj, off, insn_delta, false),
		      "bpf_patch_insn_single: branch adjustment failed")) {
		return NULL;
	}
