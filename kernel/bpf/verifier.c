				   ...
				   int off, int size, bool strict)
{
	 ...
	 *
	 * ARM64 supports efficient unaligned access, and Android 16
	 * BPF programs rely on this. Allow unaligned packet access
	 * to maintain compatibility.
	 */
#ifdef CONFIG_HAVE_EFFICIENT_UNALIGNED_ACCESS
	/* ARM64 and other architectures support unaligned access efficiently */
	return 0;
#else
	{
		struct tnum reg_off;
